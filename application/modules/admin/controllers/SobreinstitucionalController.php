 ...
 * Controlador
 *
 * @name Admin_SobreInstitucionalController
 */
class Admin_SobreInstitucionalController extends gazetamarista_Controller_Action {
	/**
	 * Armazena o model padrão da tela
	 *
	 * @access protected
	 * @name $_model
	 * @var Admin_Model_SobreInstitucional
	 */
	...
	public function init() {
		...
		$this->_model = new Admin_Model_SobreInstitucional();
	...
	public function doBeforeList($select) {
		// Redireciona
		$this->_redirect("admin/sobreinstitucional/form/idsobreInstitucional/1");
	}
    ...
    public function doAfterUpdate() {
        ...
        $id = $this->_request->getParam("idsobreInstitucional", 0);
