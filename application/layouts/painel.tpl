...
<html lang="pt-BR">
	<head>
		...
		<link
			...
			href="{$basePath}/common/default/images/favicon/57x57.png"
		/>
		<link
			rel="apple-touch-icon-precomposed"
			sizes="76x76"
			href="{$basePath}/common/default/images/favicon/76x76.png"
		/>
		<link
			rel="apple-touch-icon-precomposed"
			sizes="120x120"
			href="{$basePath}/common/default/images/favicon/120x120.png"
		/>
		<link
			rel="apple-touch-icon-precomposed"
			sizes="152x152"
			href="{$basePath}/common/default/images/favicon/152x152.png"
		/>
		<link
			rel="apple-touch-icon-precomposed"
			sizes="180x180"
			href="{$basePath}/common/default/images/favicon/180x180.png"
		/>
		...
		<meta
			...
			content="{$basePath}/common/default/images/logos/180x180.png"
		/>
		...
		<meta
			property="og:image"
			content="{$basePath}/common/default/images/logos/opengraph.jpg"
		/>
	...
	<body class="page-{$currentController}-{$currentAction}">
		...
		<!-- Topo -->
		{if $currentAction !== "login" && $currentAction !== "logout" && $currentAction !== "cadastrar" && $currentAction !== "recuperar-senha" && $currentAction !== "recuperar-sucesso" && $currentAction !== "requerer-senha"}
			{include file="default/painel/topo.tpl"}
		{else}
		...
		<!-- Whats flutuante -->
		{include file="default/geral/whats-flutuante.tpl"}
