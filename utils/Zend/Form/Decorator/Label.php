...
class Zend_Form_Decorator_Label extends Zend_Form_Decorator_Abstract
{
    ...
    /**
     * Options for the HTML tag with which to surround label
     * @var string
     */
    ...
    /**
     * Set the options to apply to the HTML tag with which to surround label
     *
    ...
    /**
     * Get the options to apply to the HTML tag, if any, with which to surround label
     *
     * @return void
     */
