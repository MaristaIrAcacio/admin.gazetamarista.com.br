...
//Zend_Debug::dump($dadosboleto);exit;
...
function fbarcode($valor){
	...
	$_application_config = Zend_Registry::get("config");
...
//Guarda inicial
?><img src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $_application_config->avadora->config->basepath; ?>/common/default/images/boleto/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
