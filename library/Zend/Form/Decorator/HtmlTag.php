...
class Zend_Form_Decorator_HtmlTag extends Zend_Form_Decorator_Abstract
{
    ...
    /**
     * Plain text to go inside HTML tag
     * @var string
     */
    ...
    public function render($content)
    {
        ...
        switch ($placement) {
            case self::APPEND:
                if ($closeOnly) {
                    return $content . $this->getPlainText() . $this->_getCloseTag($tag);
                }
                if ($openOnly) {
                    return $content . $this->_getOpenTag($tag, $attribs) . $this->getPlainText();
                }
                return $content
            ...
            case self::PREPEND:
                if ($closeOnly) {
                    return $this->getPlainText() . $this->_getCloseTag($tag) . $content;
                }
                if ($openOnly) {
                    return $this->_getOpenTag($tag, $attribs) . $this->getPlainText() . $content;
                }
