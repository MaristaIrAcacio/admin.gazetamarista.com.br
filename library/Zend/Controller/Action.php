...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
     ...
     *             redirect() instead.
     */
    protected function _redirectroute($nameroute, array $options = array())
    {
        $this->redirectroute($nameroute, $options);
    }
     ...
     * @return void
     */
    public function redirectroute($nameroute, array $options = array())
    {
        $this->_helper->redirector->gotoRoute($options, $nameroute);
    }
}
