...
class Zend_Db_Select
{
    ...
    /**
     * Executa a querie direto do select, sem necessidade de instanciar o model para isso
     *
     * @param integer $fetchMode OPTIONAL
     * @param mixed $bind An array of data to bind to the placeholders.
     *
     ...
     */
    public function fetchAll($fetchMode = Zend_Db::FETCH_OBJ, $bind = array())
    {
        if (!empty($bind)) {
            $this->bind($bind);
        }
    ...
    /**
     * Executa a querie direto do select e pegando apenas 1 item, sem necessidade de instanciar o model para isso
     *
     * @param string $class OPTIONAL Name of the class to create.
     * @param array $config OPTIONAL Constructor arguments for the class.
     * @return mixed One object instance of the specified class, or false.
     */
    public function fetchRow($class = 'stdClass', array $config = array())
    {
        // Limita 1 item
        $this->limit(1);
     ...
     * @return mixed One object instance of the specified class, or false.
     */
    public function fetchOne($class = 'stdClass', array $config = array())
    {
        return $this->fetchRow($class, $config);
    }
}