...
$var_arr_path 	= explode("/", $pathname);

if($hostname == "localhost" || $hostname == "www.sites.gazetamarista.com.br" || $hostname == "sites.gazetamarista.com.br") {
	$baseUrl = "/" . $var_arr_path[1] . "/common/uploads/ckeditor/";
}else{
	$baseUrl = "/common/uploads/ckeditor/";
}
